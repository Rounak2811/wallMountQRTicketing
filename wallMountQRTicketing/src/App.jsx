...
function App() {
  return (
    <>
      ...
      <marquee><h2 className="p-1">Welcome to Kolkata Metro - India's First Metro </h2></marquee>
      <div>
        <Carousels />
        <button type="button" className="btn btn-primary m-3 p-2 fs-4 rounded">Buy Ticket</button>
      </div>
      <CRISFooter />
    </>
  )
