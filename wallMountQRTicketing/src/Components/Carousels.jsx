            ...
            <div id="carouselExampleAutoplaying" className="carousel slide p-20" data-bs-ride="carousel">
                <div className="carousel-inner">
                    <div className="carousel-item active">
                        <img src={image1} className=" w-60 m-auto" alt="Kolkata Metro underwater train" />
                    </div>
                    <div className="carousel-item">
                        <img src={image2} className=" w-60 m-auto" alt="Kolkata Metro train" />
                    </div>
                    <div className="carousel-item">
                        <img src={image3} className=" w-60 m-auto" alt="Kolkata Metro history" />
                    </div>
                </div>
